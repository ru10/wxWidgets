dnl ### begin block 00_header[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
dnl
...
dnl ### begin block 20_COND_BUILD_debug[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_BUILD_debug="#"
    if test "x$BUILD" = "xdebug" ; then
        COND_BUILD_debug=""
    fi
    AC_SUBST(COND_BUILD_debug)
dnl ### begin block 20_COND_BUILD_debug_DEBUG_INFO_default[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_BUILD_release[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_BUILD_release="#"
    if test "x$BUILD" = "xrelease" ; then
        COND_BUILD_release=""
    fi
    AC_SUBST(COND_BUILD_release)
dnl ### begin block 20_COND_BUILD_release_DEBUG_INFO_default[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_DEBUG_FLAG_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_DEBUG_FLAG_0="#"
    if test "x$DEBUG_FLAG" = "x0" ; then
        COND_DEBUG_FLAG_0=""
    fi
    AC_SUBST(COND_DEBUG_FLAG_0)
dnl ### begin block 20_COND_DEBUG_INFO_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_DEBUG_INFO_0="#"
    if test "x$DEBUG_INFO" = "x0" ; then
        COND_DEBUG_INFO_0=""
    fi
    AC_SUBST(COND_DEBUG_INFO_0)
dnl ### begin block 20_COND_DEBUG_INFO_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_DEBUG_INFO_1="#"
    if test "x$DEBUG_INFO" = "x1" ; then
        COND_DEBUG_INFO_1=""
    fi
    AC_SUBST(COND_DEBUG_INFO_1)
dnl ### begin block 20_COND_DEPS_TRACKING_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_DEPS_TRACKING_0="#"
    if test "x$DEPS_TRACKING" = "x0" ; then
        COND_DEPS_TRACKING_0=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_0)
dnl ### begin block 20_COND_DEPS_TRACKING_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_MONOLITHIC_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_MONOLITHIC_0="#"
...
dnl ### begin block 20_COND_MONOLITHIC_0_SHARED_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_MONOLITHIC_0_USE_MEDIA_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_MONOLITHIC_0_USE_WEBVIEW_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_MONOLITHIC_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_MONOLITHIC_1="#"
...
dnl ### begin block 20_COND_OFFICIAL_BUILD_0_PLATFORM_WIN32_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_OFFICIAL_BUILD_1_PLATFORM_WIN32_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_PLATFORM_MACOSX_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_PLATFORM_MAC_0[../../samples/maskededit/maskededit.bkl] ###
    COND_PLATFORM_MAC_0="#"
    if test "x$PLATFORM_MAC" = "x0" ; then
        COND_PLATFORM_MAC_0=""
    fi
    AC_SUBST(COND_PLATFORM_MAC_0)
dnl ### begin block 20_COND_PLATFORM_MAC_1[../../samples/maskededit/maskededit.bkl] ###
    COND_PLATFORM_MAC_1="#"
...
dnl ### begin block 20_COND_PLATFORM_OS2_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_PLATFORM_OS2_1="#"
    if test "x$PLATFORM_OS2" = "x1" ; then
        COND_PLATFORM_OS2_1=""
    fi
    AC_SUBST(COND_PLATFORM_OS2_1)
dnl ### begin block 20_COND_PLATFORM_UNIX_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_PLATFORM_UNIX_0="#"
    if test "x$PLATFORM_UNIX" = "x0" ; then
        COND_PLATFORM_UNIX_0=""
    fi
    AC_SUBST(COND_PLATFORM_UNIX_0)
dnl ### begin block 20_COND_PLATFORM_UNIX_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_PLATFORM_WIN32_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_PLATFORM_WIN32_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_SHARED_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_SHARED_1="#"
...
dnl ### begin block 20_COND_TOOLKIT_COCOA[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_TOOLKIT_COCOA="#"
...
dnl ### begin block 20_COND_TOOLKIT_MAC[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_TOOLKIT_MAC="#"
...
dnl ### begin block 20_COND_TOOLKIT_MSW[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_TOOLKIT_MSW="#"
...
dnl ### begin block 20_COND_TOOLKIT_OSX_CARBON[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_TOOLKIT_OSX_COCOA[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_TOOLKIT_OSX_IPHONE[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_UNICODE_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_UNICODE_1="#"
    if test "x$UNICODE" = "x1" ; then
        COND_UNICODE_1=""
    fi
    AC_SUBST(COND_UNICODE_1)
dnl ### begin block 20_COND_USE_CAIRO_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_CAIRO_1="#"
    if test "x$USE_CAIRO" = "x1" ; then
        COND_USE_CAIRO_1=""
    fi
    AC_SUBST(COND_USE_CAIRO_1)
dnl ### begin block 20_COND_USE_EXCEPTIONS_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_EXCEPTIONS_0="#"
    if test "x$USE_EXCEPTIONS" = "x0" ; then
        COND_USE_EXCEPTIONS_0=""
    fi
    AC_SUBST(COND_USE_EXCEPTIONS_0)
dnl ### begin block 20_COND_USE_EXCEPTIONS_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_EXCEPTIONS_1="#"
    if test "x$USE_EXCEPTIONS" = "x1" ; then
        COND_USE_EXCEPTIONS_1=""
    fi
    AC_SUBST(COND_USE_EXCEPTIONS_1)
dnl ### begin block 20_COND_USE_GUI_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_GUI_0="#"
    if test "x$USE_GUI" = "x0" ; then
        COND_USE_GUI_0=""
    fi
    AC_SUBST(COND_USE_GUI_0)
dnl ### begin block 20_COND_USE_GUI_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_GUI_1="#"
...
dnl ### begin block 20_COND_USE_GUI_1_wxUSE_LIBJPEG_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_GUI_1_wxUSE_LIBJPEG_builtin="#"
    if test "x$USE_GUI" = "x1" -a "x$wxUSE_LIBJPEG" = "xbuiltin" ; then
        COND_USE_GUI_1_wxUSE_LIBJPEG_builtin=""
    fi
    AC_SUBST(COND_USE_GUI_1_wxUSE_LIBJPEG_builtin)
dnl ### begin block 20_COND_USE_GUI_1_wxUSE_LIBPNG_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_GUI_1_wxUSE_LIBPNG_builtin="#"
    if test "x$USE_GUI" = "x1" -a "x$wxUSE_LIBPNG" = "xbuiltin" ; then
        COND_USE_GUI_1_wxUSE_LIBPNG_builtin=""
    fi
    AC_SUBST(COND_USE_GUI_1_wxUSE_LIBPNG_builtin)
dnl ### begin block 20_COND_USE_GUI_1_wxUSE_LIBTIFF_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
...
dnl ### begin block 20_COND_USE_PLUGINS_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_PLUGINS_0="#"
    if test "x$USE_PLUGINS" = "x0" ; then
        COND_USE_PLUGINS_0=""
    fi
    AC_SUBST(COND_USE_PLUGINS_0)
dnl ### begin block 20_COND_USE_RTTI_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_RTTI_0="#"
    if test "x$USE_RTTI" = "x0" ; then
        COND_USE_RTTI_0=""
    fi
    AC_SUBST(COND_USE_RTTI_0)
dnl ### begin block 20_COND_USE_RTTI_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_RTTI_1="#"
...
dnl ### begin block 20_COND_USE_THREADS_0[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_THREADS_0="#"
    if test "x$USE_THREADS" = "x0" ; then
        COND_USE_THREADS_0=""
    fi
    AC_SUBST(COND_USE_THREADS_0)
dnl ### begin block 20_COND_USE_THREADS_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_USE_THREADS_1="#"
...
dnl ### begin block 20_COND_WXUNIV_1[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_WXUNIV_1="#"
    if test "x$WXUNIV" = "x1" ; then
        COND_WXUNIV_1=""
    fi
    AC_SUBST(COND_WXUNIV_1)
dnl ### begin block 20_COND_wxUSE_EXPAT_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_wxUSE_EXPAT_builtin="#"
    if test "x$wxUSE_EXPAT" = "xbuiltin" ; then
        COND_wxUSE_EXPAT_builtin=""
    fi
    AC_SUBST(COND_wxUSE_EXPAT_builtin)
dnl ### begin block 20_COND_wxUSE_LIBJPEG_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_wxUSE_LIBJPEG_builtin="#"
    if test "x$wxUSE_LIBJPEG" = "xbuiltin" ; then
        COND_wxUSE_LIBJPEG_builtin=""
    fi
    AC_SUBST(COND_wxUSE_LIBJPEG_builtin)
dnl ### begin block 20_COND_wxUSE_LIBPNG_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_wxUSE_LIBPNG_builtin="#"
    if test "x$wxUSE_LIBPNG" = "xbuiltin" ; then
        COND_wxUSE_LIBPNG_builtin=""
    fi
    AC_SUBST(COND_wxUSE_LIBPNG_builtin)
dnl ### begin block 20_COND_wxUSE_LIBTIFF_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_wxUSE_LIBTIFF_builtin="#"
    if test "x$wxUSE_LIBTIFF" = "xbuiltin" ; then
        COND_wxUSE_LIBTIFF_builtin=""
    fi
    AC_SUBST(COND_wxUSE_LIBTIFF_builtin)
dnl ### begin block 20_COND_wxUSE_REGEX_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
    COND_wxUSE_REGEX_builtin="#"
    if test "x$wxUSE_REGEX" = "xbuiltin" ; then
        COND_wxUSE_REGEX_builtin=""
    fi
    AC_SUBST(COND_wxUSE_REGEX_builtin)
dnl ### begin block 20_COND_wxUSE_ZLIB_builtin[../../samples/maskededit/maskededit.bkl,wx.bkl] ###
